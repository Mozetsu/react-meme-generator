...
## Conclusion
This project helped me consolidate the fundamentals of React, and gave me a better understanding about how to structure a project in a way that is more efficient to work with components. Moreover, I felt comfortable handling the data flow using hooks and felt little to no difficulty when had to move events between components throughout the development process.
